...
import com.nekocraft.launcher.exceptions.NoMirrorsAvailableException;
import com.nekocraft.launcher.exceptions.RestfulAPIException;
import com.nekocraft.launcher.rest.*;
...
public final class NekocraftData {
    ...
    /**
     * Creates a snapshot of Nekocraft build information
     *
     * @throws RestfulAPIException
     */
    public NekocraftData() throws RestfulAPIException {
    ...
    private static String calculateInstall() throws RestfulAPIException {
        File spoutcraft = new File((new NekocraftDirectories()).getBinDir(), "spoutcraft.jar");
