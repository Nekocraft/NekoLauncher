 ...
 */
package com.nekocraft.launcher.skin.components;
...
public abstract class LoginFrame extends JFrame implements DownloadListener {
    ...
    public static final URL spoutcraftIcon = LoginFrame.class.getResource("/com/nekocraft/launcher/resources/icon.png");
    ...
    public final Font getMinecraftFont(int size) {
        Font minecraft;
        try {
            minecraft = Font.createFont(Font.TRUETYPE_FONT, getResourceAsStream("/com/nekocraft/launcher/resources/minecraft.ttf")).deriveFont((float) size);
        } catch (Exception e) {
            e.printStackTrace();
            // Fallback
