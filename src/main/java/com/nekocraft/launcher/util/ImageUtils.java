...
public class ImageUtils {
    ...
    private static BufferedImage getSkinImage(String url) {
        ...
        try {
            ...
            return ImageIO.read(getResourceAsStream("/com/nekocraft/launcher/resources/char.png"));
        } catch (Exception e) {
            try {
                return ImageIO.read(getResourceAsStream("/com/nekocraft/launcher/resources/char.png"));
    ...
    private static JButton getShadow(JPanel contentPane, List<JButton> buttons, int x, int y, BufferedImage skinImage) {
        ...
        try {
            ...
            blackGlow = new ImageIcon(ImageIO.read(getResourceAsStream("/com/nekocraft/launcher/resources/char_normal.png")));
            whiteGlow = new ImageIcon(ImageIO.read(getResourceAsStream("/com/nekocraft/launcher/resources/char_hover.png")));
